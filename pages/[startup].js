                ...
                <div className={S.info}>
                    <div className={S.r1}>
                        <div className={S.card1}>
                            ...
                            <div className={S.det}>
                                <div className={S.hed}><span className={S.uni}>Unicorn</span><br></br>{props.sp.Shortbrief}</div>
                        ...
                        <div className={S.card2}>
                            <div className={S.m1}>
                                ...
                                <div className={S.tim}>
                                    ...
                                    <div className={S.cir1}><Image src={dt}></Image></div>
                                    <div className={S.cir2}><Image src={dt}></Image></div>
                                    <div className={S.cir3}><Image src={dt}></Image></div>
                                </div>
                            </div>
                            <div className={S.m1}>
                                ...
                                <div className={S.val}>
                                    <div className={S.v1}>
                                        <div className={S.vt}>Valuation</div>
                                        <div className={S.vt}>Funds raised</div>
                                        <div className={S.vt}>Revenue</div>
                                        <div className={S.vt}>Profit/Loss</div>
                                    </div>
                                    <div className={S.v1}>
                                        <div className={S.vt1}>$1.5 B</div>
                                        <div className={S.vt1}>$116M</div>
                                        <div className={S.vt1}>$13.2M</div>
                                        <div className={S.vt1}>-</div>
                                    </div>
                                </div>
                            </div>
                            <div className={S.m2}>
