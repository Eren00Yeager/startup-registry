                    ...
                    <div className={styles.twoBoxes}>
                        <div className={styles.b1}>
                            ...
                            <div className={styles.boxcontent}>
                                {News.map((item,key)=>{
                                    ...
                                    if(key!=0){
                                    return(
                                        item[0] != "" && <div className={styles.svgs}> {windowSize.width > 1000 ? <Image src= { `https://drive.google.com/uc?export=view&id=${item[4].slice(32, 65)}` } height={"30px"} width={"30px"} />:<Image height={"20px"} width={"20px"} src= { `http://drive.google.com/uc?export=view&id=${item[4].slice(32, 65)}` } />}<div className={styles.content}>{item[0]}</div></div>
                                    )
                                    }
                                })}
                            </div>
                        ...
                        <div className={styles.b1}>
                            ...
                            {News.map((item,key)=>{
                                    if(key!=0){
                                    return(
                                        item[1] != "" && <div className={styles.svgs}> {windowSize.width > 1000 ? <Image src= { `https://drive.google.com/uc?export=view&id=${item[5].slice(32, 65)}`} height={"30px"} width={"30px"} />:<Image height={"20px"} width={"20px"}  src= { `http://drive.google.com/uc?export=view&id=${item[5].slice(32, 65)}` } />}<div className={styles.content}>{item[1]}</div></div>
